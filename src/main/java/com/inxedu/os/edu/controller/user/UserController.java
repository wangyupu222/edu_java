...
//		    	        }  
			String randomCode = (String)request.getSession().getAttribute(CommonConstants.RAND_CODE);
			...
			if("true".equals(ipForget)){
				...
				EHCacheUtil.get(CacheConstans.USER_CURRENT_LOGINTIME+user.getUserId());
				...
				Object object = EHCacheUtil.get(CacheConstans.USER_CURRENT_LOGINTIME+user.getUserId());
				System.out.println();
				String aaa=CommonConstants.MYDOMAIN;
